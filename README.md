...
![Animation shows "star wars" typed into a search box and books about Star Wars appearing as results.](./assets/demo-2.gif)

The user can save books by clicking "Save This Book!" under each search result, as shown in the following animation:

![Animation shows user clicking "Save This Book!" button to save books that appear in search results. The button label changes to "Book Already Saved" after it is clicked and the book is saved.](./sssets/demo-02.gif)
...
## Resources
[UtorGitlab](https://utoronto.bootcampcontent.com/utoronto-bootcamp/utor-virt-bo-fsf-pt-06-2021-u-b/-/tree/master/21-MERN)
[Apollo Doc](https://www.apollographql.com/docs/)
[StackFlow](https://stackoverflow.com/questions/65916235/apollo-mutation-on-react-hooks)